...
void Cadastro(P A[], int *qnt_p)
{
    ...
    {
        printf("\t\t+---------------------------------------------------------+\n");
        printf("\t\t| Produto j� existe no estoque!                           |\n");
        printf("\t\t+---------------------------------------------------------+\n");
    }
...
void Registro(P A[], V B[], int *qnt_p, int *qnt_v)
{
    ...
    printf("\n\t\t| Digite o c�digo do produto para venda: ");
    scanf("%d", &aux);
...
void L_Produtos_D(P A[],int *qnt_p)
{
    ...
    tam = *qnt_p;
    printf("\n\n\t\t+---------------------------------------------------------+\n");
    printf("\t\t|                 LISTA DE PRODUTOS DISPON�VEIS            |\n");
    printf("\t\t+---------------------------------------------------------+\n");
    ...
    for(; i<tam; i++)
    {
        if(A[i].qnt_E>0)
        {
            printf("\n\t\t| C�digo: %d | Nome: %s | Quantidade: %d | Pre�o: R$%.2f |\n", A[i].codigo, A[i].Nome, A[i].qnt_E, A[i].Pv);;
        }
    }
    printf("\n\t\tPressione ENTER para continuar...");
    fflush(stdin);
...
void relatorio(V B[], int *b)
{
    ...
    while (1)
    {
        ...
        do
        {
            printf("\n\t\t\tDigite o c�digo do relat�rio: ");
            scanf("%d", &aux);
            if (aux < 1 || aux > 4)
                printf("\t\t\tC�digo inv�lido! Digite um n�mero de 1 a 4.\n");
        }
        while (aux < 1 || aux > 4);
        ...
        case 1:
        {
            ...
            printf("\t\t+---------------------------------------------------------------------+\n");
            printf("\t\t| C�digo do Produto: %-10d Quantidade Total Vendida: %-5d       \n", codigoMaisVendido, maisVendidoQtd);
            printf("\t\t| C�digos das Vendas:                                                 \n");
        ...
        case 2:
        {
            ...
            for (int i = 0; i < qnt_v; i++)
            {
                ...
                if (!ja_listado)
                {
                    printf("\t\t| Nome do Produto: %-30s C�digo: %-5d          \n", B[i].p_Ve.Nome, B[i].p_Ve.codigo);
                    total_vendido = 0;
                    for (int j = 0; j < qnt_v; j++)
                    {
                    ...
                    for (int k = 0; k < qnt_v; k++)
                    {
                        ...
                        {
                            printf("\t\t| -> C�digo da Venda: %-5d  Quantidade: %.0f                  \n",
        ...
        case 3:
        {
            ...
            for (int i = 0; i < qnt_v; i++)
            {
                printf("\t\t| Venda #%03d | Produto C�digo: %d  Nome: %-20s \n",
                       B[i].codigo_V, B[i].p_Ve.codigo, B[i].p_Ve.Nome);
                printf("\t\t| Quantidade: %.0f | Pre�o Unit�rio: R$%.2f | Valor Venda: R$%.2f   \n",
...
int main()
{
    ...
    while(rod==1)
    {
        ...
        printf("\t\t\t|   #3 -> Listar Produtos Dispon�veis                                 |\n");
        ...
        do
        {
            printf("\n\t\t\tDigite o c�digo da fun��o: ");
            scanf("%d", &aux);

            if (aux < 1 || aux > 7)
            {
                printf("\n\t\t\tC�digo inv�lido! Digite um n�mero de 1 a 7:");
                scanf("%d", &aux);
            }
        }
        while (aux < 1 || aux > 7);
